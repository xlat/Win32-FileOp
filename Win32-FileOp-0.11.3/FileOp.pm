...
tie $Win32::FileOp::GetCompressedFileSize, 'Lazy', sub {
...
tie $Win32::FileOp::QueryDosDevice, 'Lazy', sub {
  new Win32::API("kernel32.dll", "QueryDosDevice", ['P','P','L'], 'L')
  or
  die "new Win32::API::QueryDosDevice: $!\n"
}, &LAZY_READONLY;

tie $Win32::FileOp::DefineDosDevice, 'Lazy', sub {
